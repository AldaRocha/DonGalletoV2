...
from compras_app.views import ListaComprasView, CrearComprasView, EditarComprasView, ListaDetalleComprasView, CrearDetalleComprasView, EditarDetalleComprasView
