...
from galletas_app.views import ListaGalletasView, CrearGalletasView, EditarGalletasView, SolicitarGalletasView, EliminarGalletaView
...
urlpatterns = [
    ...
    path("solicitar_galletas/<int:pk>/", login_required(SolicitarGalletasView), name="solicitar_galletas"),
