...
from ventas_app.views import ListaVenderView, agregar_al_carrito, ver_carrito, procesar_venta, eliminar_del_carrito, historial_ventas, ver_detalles_venta, descargar_ticket, cancelar_carrito
...
urlpatterns = [
    ...
    path('cancelar-carrito/', cancelar_carrito, name='cancelar_carrito'),
